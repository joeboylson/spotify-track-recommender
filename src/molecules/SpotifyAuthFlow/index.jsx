      ...
      {spotifyUser ? (
        ...
        <CreatePlaylistWrapper>
          ...
          <p>
            ...
            main login page. Follow the steps Spotify provides and we'll see you
            back here.
          </p>
          <p>
            If you've authenticated before, you will not be redirected but will
            be given the option to name and save the playlist right away.
          </p>
          <i>
            Don't worry, your data and your Spotify account are safe. Your login
            is only used to see your Spotify account and create a playlist (if
            you choose to do so).
          </i>
